...
--
-- Host: 127.0.0.1
-- Generation Time: 20 Mei 2018 pada 14.26
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
--
-- Struktur dari tabel `guru_tr`
--

CREATE TABLE IF NOT EXISTS `guru_tr` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1257 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;

--
-- Dumping data untuk tabel `guru_tr`
--
...
(1, 'Elichika Ayase', 'P', '9A', 'Meminjam', 'Communist Manifesto', '', '2018-05-12', '20:56:03'),
(2, 'ad', 'L', '7B', 'Meminjam', 'ad', 'ada', '2018-05-13', '18:15:09'),
(3, 'ad', 'L', '7B', 'Meminjam', 'ad', 'ada', '2018-05-13', '18:15:09'),
(4, 'ad', 'L', '7A', 'Meminjam', 'ad', 'ad', '2018-05-13', '18:17:18'),
(5, 'a', 'L', '7A', '', 'aa', 'ad', '2018-05-13', '18:35:03'),
(6, 'ad', 'L', '7A', 'Meminjam', 'ad', 'ada', '2018-05-13', '18:46:40');
...
) ENGINE=InnoDB AUTO_INCREMENT=1900 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
(1000, 'Akhlak Siswa Terhadap Guru', 'Murtini, S.Pd.', 'PT. SINDUR PRESS', '978-979-9107-74-9', 18, 'Rak B'),
...
--
ALTER TABLE `guru_tr`
 ADD PRIMARY KEY (`idtrx`), ADD KEY `judul` (`judul`), ADD KEY `id` (`id`), ADD KEY `nip` (`nip`) USING BTREE;

--
-- Indexes for table `peminjaman`
--
ALTER TABLE `peminjaman`
 ADD PRIMARY KEY (`idtrx`), ADD KEY `judul` (`judul`), ADD KEY `nis` (`nis`) USING BTREE, ADD KEY `id` (`id`);
...
ALTER TABLE `tbl_buku`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `judul` (`judul`);
...
--
ALTER TABLE `guru_tr`
MODIFY `idtrx` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1257;
--
-- AUTO_INCREMENT for table `peminjaman`
--
ALTER TABLE `peminjaman`
MODIFY `idtrx` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1258;
--
