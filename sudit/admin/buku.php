...
<!-- Penambahan Navigasi Bar Atas belum-->
           ...
           <center><div class="container-fluid">
             ...
             if(isset($_GET['hal']) == 'hapus'){
				...
				if(mysqli_num_rows($cek) == 0){
					...
					$delete = mysqli_query($koneksi, "DELETE FROM tbl_buku WHERE id='$id'");
					if($delete){
			...
			?>
                        ...
                        <div class="panel-body table-responsive">
                            ...
                            <a href="?page=buku_input" class="btn btn-sm btn-primary">Tambah Buku</a>
                            </div>
                                </div>
                            </div>
        ...
        <div class="footer span-12">
            <div class="container">
              <center> <b class="copyright"><a href=""> Universitas Lampung</a> &copy; 2018 DataTables by Sudit </b></center>
            </div>
        </div>
